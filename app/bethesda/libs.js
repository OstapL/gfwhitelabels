...
app.on('urlsReady', function() {
    ...
    let appRoutes = Backbone.Router.extend({
        ...
        campaignList: function() {
            requirejs(['models/campaign', 'views/campaign', 'templates/campaignList'], function(model, view, campaignListT) {
        ...
        campaignDetail: function(id) {
            requirejs(['models/campaign', 'views/campaign', 'templates/campaignDetail'], (model, view, campaignDetailT) => {
        ...
        campaignInvest: function(id) {
            requirejs(['models/campaign', 'models/investment', 'views/campaign', 'templates/campaignInvestment'], (model, investModel, view, campaignInvestmentT) => {
        ...
        accountProfile: function() {
            requirejs(['models/user', 'views/user', 'templates/user'], (model, view, template) => {
        ...
        pageDetail: function(id) {
            requirejs(['models/page', 'views/page', 'templates/pageDetail'], (model, view, pageDetailT) => {
        ...
        mainPage: function(id) {
            requirejs(['models/page', 'views/page', 'templates/mainPage'], (model, view, mainPageT) => {
                app.cache[window.location.pathname] = mainPageT;
                $('#content').html(mainPageT);
                app.hideLoading();
            });
        },

        login: function(id) {
            requirejs(['views/user', 'templates/userLogin'], (userView, userT) => {
    ...
    app.on('userReady', function(){
        ...
        require(['views/menu', 'templates/menu'], (menu, menuT) => {
