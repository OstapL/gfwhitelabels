  ...
  previewPdf: Backbone.View.extend({
    ...
    initialize(slug, rawData) {
      if (window.navigator && window.navigator.msSaveOrOpenBlob) { // IE workaround
        ...
        iframe.setAttribute('style', "display:block; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999; overflow-y: auto; -webkit-overflow-scrolling:touch;");
