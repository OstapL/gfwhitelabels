...
function(a) {
    ...
    $(".btn-group a").click(function() {
        var a = $(this).attr("id");
        $(this).hasClass("open") ? ($("#" + a + "_d").fadeOut("normal"), $(this).removeClass("open")) : ($("#" + a + "_d").fadeIn("normal"), $(this).addClass("open"))
    })
}), $().ready(function() {
    $("#open_menu").click(function() {
        $(this).hasClass("opened") ? ($(".in_mob").fadeOut("normal"), $(this).removeClass("opened")) : ($(".in_mob").fadeIn("normal"), $(this).addClass("opened"))
    })
}), $().ready(function() {
    /*var true_pos = $('.progress-bar').get(0).style.width;
    var pos = parseInt(true_pos);
    var new_position = 100 - pos;
    var new_padding = 20 - new_position;
    if (pos >= 90) {
        $('#poss').css({'padding-right': new_padding + '%','margin-right': '-' + new_position + '%','background-position-x': new_position + '%'});
    }*/
});