        ...
        $( function()
{
    ...
    targets.bind( 'mouseenter', function()
    {
        ...
        {
            if( $( window ).width() < tooltip.outerWidth() * 1 )
                tooltip.css( 'max-width', $( window ).width() / 1 );
            else
            ...
            if( pos_left < 0 )
            {
                pos_left = target.offset().left + target.outerWidth() / 3 - 50;
            ...
            {
                pos_left = target.offset().left - tooltip.outerWidth() + target.outerWidth() / 1 - 80;
