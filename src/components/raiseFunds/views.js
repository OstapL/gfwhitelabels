...
module.exports = {
  company: Backbone.View.extend(_.extend(menuHelper.methods, leavingConfirmationHelper.methods, phoneHelper.methods, {
    ...
    }, menuHelper.events, leavingConfirmationHelper.events, phoneHelper.events),
  ...
  generalInformation: Backbone.View.extend(_.extend(addSectionHelper.methods, menuHelper.methods, leavingConfirmationHelper.methods, {
    ...
    events: _.extend({
      ...
      'click .onPreview': onPreviewAction,
    }, addSectionHelper.events, menuHelper.events, jsonActions.events, leavingConfirmationHelper.events),
  ...
  media: Backbone.View.extend(_.extend(addSectionHelper.methods, menuHelper.methods, leavingConfirmationHelper.methods, {
  ...
  teamMemberAdd: Backbone.View.extend(_.extend(menuHelper.methods, leavingConfirmationHelper.methods, {
  ...
  specifics: Backbone.View.extend(_.extend(menuHelper.methods, leavingConfirmationHelper.methods, {
  ...
  perks: Backbone.View.extend(_.extend(addSectionHelper.methods, menuHelper.methods, leavingConfirmationHelper.methods, {
